...
profile:
    ...
    :plugins [[cc.artifice/codox "0.7.0-SNAPSHOT"]]

Or, if you're using a version of Leiningen prior to 1.7.0:

    :dev-dependencies [[cc.artifice/codox "0.7.0-SNAPSHOT"]]
...
```clojure
:codox {:marginalia-dir "../marginalia" ;; for lein marg docs
        :gossip-dir "../gossip"         ;; for lein gossip graphs
        :fnviz-dir "../fnviz"}          ;; for geppetto fnviz graphs
```
